...
async function testAuth() {
  ...
  try {
    ...
    log(`Response Status: ${getResponse.status} ${getResponse.statusText}`, 
        getResponse.ok ? 'green' : 'red');
  ...
  try {
    ...
    log(`Response Status: ${userResponse.status} ${userResponse.statusText}`, 
        userResponse.ok ? 'green' : 'red');
