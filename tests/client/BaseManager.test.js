...
describe("BaseManager", () => {
  ...
  describe("Configuration Management", () => {
    ...
    it("should maintain config immutability", () => {
      const originalConfig = { ...baseManager.config };
  ...
  describe("Async Patterns", () => {
    ...
    it("should handle async initialization errors", async () => {
      ...
      await expect(
        asyncManager.initializeAsync()
      ).rejects.toThrow("API key required for initialization");
    });
    ...
    it("should support async operation patterns", async () => {
      ...
      await expect(
        asyncManager.performAsyncOperation({})
