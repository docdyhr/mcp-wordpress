...
describe("BaseToolManager", () => {
  ...
  describe("Client Management", () => {
    ...
    it("should throw error for invalid site", () => {
      toolManager.siteClients = new Map([["valid-site", mockWordPressClient]]);
  ...
  describe("Tool Execution", () => {
    it("should execute tool handlers successfully", async () => {
      ...
      const result = await toolManager.getItem({ id: 123 });
    ...
    it("should pass parameters correctly to handlers", async () => {
      ...
      expect(mockWordPressClient.post).toHaveBeenCalledWith("/test/items", {
        title: "New Item",
    ...
    it("should maintain tool context during execution", async () => {
      ...
      const result = await toolManager.getItem({ id: 123, site: "test-site" });
  ...
  describe("Integration", () => {
    ...
    it("should handle concurrent tool executions", async () => {
      ...
      const promises = [toolManager.getItem({ id: 1 }), toolManager.getItem({ id: 2 }), toolManager.getItem({ id: 3 })];
