...
describe("Debug Utilities", () => {
  ...
  describe("Debug Logger", () => {
    ...
    it("should handle array logging", () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining("Array test"),
        testArray
      );
    });
  ...
  describe("Debug Conditional Logging", () => {
    ...
    it("should handle various truthy DEBUG values", () => {
      ...
      truthyValues.forEach(value => {
        ...
        expect(consoleLogSpy).toHaveBeenCalledWith(
          expect.stringContaining(`Debug with ${value}`)
        );
      });
  ...
  describe("Integration Patterns", () => {
    it("should work with async/await patterns", async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining("Async operation complete")
      );
    });
    ...
    it("should work with Promise chains", async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining("First then"),
        "initial"
      );
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining("Second then"),
        "initial-processed"
      );
    });
